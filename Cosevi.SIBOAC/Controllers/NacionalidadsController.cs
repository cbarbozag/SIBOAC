...
namespace Cosevi.SIBOAC.Controllers
{
    public class NacionalidadsController : Controller
    {
        ...
        {
            string mensaje = "";
            bool exist = db.NACIONALIDAD.Any(x => x.Id == id);
            if (exist)
            {
        ...
        public ActionResult Details(string id, string estado)
        {
            if (id == null || estado == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            Nacionalidad nacionalidad = db.NACIONALIDAD.Find(id, estado);
        ...
        public ActionResult Create([Bind(Include = "Id,Descripcion,Estado,FechaDeInicio,FechaDeFin,Prioridad")] Nacionalidad nacionalidad)
        {
            if (ModelState.IsValid)
            {
                ...
                string mensaje = Verificar(nacionalidad.Id);
                if (mensaje == "")
                {
                    db.SaveChanges();
        ...
        public ActionResult Edit(string id, string estado)
        {
            if (id == null || estado == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        public ActionResult Delete(string id, string estado)
        {
            if (id == null || estado == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(string id, string estado)
        {
            Nacionalidad nacionalidad = db.NACIONALIDAD.Find(id, estado);
